...
def returnn():
    ...
    global SubmitBtn,labelFrame,lb1,lb2,bookInfo1,quitBtn,root,Canvas1,status
...
def returnBook(): 
    ...
    global bookInfo1,SubmitBtn,quitBtn,Canvas1,con,cur,root,labelFrame,lb2, lb1
